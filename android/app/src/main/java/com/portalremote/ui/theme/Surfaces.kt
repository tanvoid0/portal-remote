 ...
 *
 * A filled card and the surface under it are one step apart on the neutral ramp, which
 * is a step a phone screen in daylight loses entirely; every card in this app therefore
 * carries a hairline edge as well as a fill. Doing it per call site is how the two
 * halves of a design system drift, so both the fill and the edge come from here.
 */
@Composable
...
@Composable
fun portalCardBorder(): BorderStroke =
    BorderStroke(1.dp, PortalRemoteTheme.extendedColors.border)
